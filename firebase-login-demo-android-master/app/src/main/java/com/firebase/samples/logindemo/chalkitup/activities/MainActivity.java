...
public class MainActivity extends ActionBarActivity implements
    ...
    private Button mGotToGamesButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGotToGamesButton = (Button) findViewById(R.id.games_button);
    ...
    private void setupAnonymousAuth() {
    /* *************************************
     *               PASSWORD              *
     ***************************************/
...
//            mTwitterLoginButton.setVisibility(View.GONE);
            ...
            mCreateNewAccountButton.setVisibility(View.GONE);
            mEmailText.setVisibility(View.GONE);
            mPasswordText.setVisibility(View.GONE);
            mGotToGamesButton.setVisibility(View.VISIBLE);
            ...
            if (name != null) {
                mLoggedInStatusTextView.setText("Logged in as " + authData.getProviderData().get("email") + " (" + authData.getProvider() + ")");
            }
...
//            mTwitterLoginButton.setVisibility(View.VISIBLE);
            mPasswordLoginButton.setVisibility(View.GONE);
            mAnonymousLoginButton.setVisibility(View.GONE);
            mCreateNewAccountButton.setVisibility(View.VISIBLE);
            mEmailText.setVisibility(View.VISIBLE);
            mPasswordText.setVisibility(View.VISIBLE);
            mGotToGamesButton.setVisibility(View.GONE);
    ...
    private class AuthResultHandler implements Firebase.AuthResultHandler {
        ...
        public void onAuthenticationError(FirebaseError firebaseError) {
            mAuthProgressDialog.hide();
            showErrorDialog("Please check email or password again");
    ...
    public void loginWithPassword() {
        mAuthProgressDialog.show();
        mFirebaseRef.authWithPassword("jheffer444@gmail.com", "jeff4", new AuthResultHandler("password"));
    }
    ...
    public void createNewAccount() {
        ...
        mFirebaseRef.createUser(email, password, new Firebase.ResultHandler() {
            ...
            public void onSuccess() {
                ...
                Toast.makeText(getApplicationContext(), "Loggin in",
                        Toast.LENGTH_LONG).show();
            }
            @Override
    ...
    public void onNavigateToGames(View view) {
